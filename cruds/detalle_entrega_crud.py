...
class DetalleEntregaCRUD(CRUDBase[DetalleEntrega, DetalleEntregaCreate, DetalleEntregaUpdate]):
    ...
    def __init__(self):
        ...
        # Configuraciones específicas para DetalleEntrega
        self.longitud_minima_descripcion = 5
        self.longitud_maxima_descripcion = 500
        self.peso_minimo = 0.1  # en kg
        self.peso_maximo = 100.0  # en kg
        self.valor_minimo = 0.0
        self.valor_maximo = 1000000.0  # Valor máximo para el envío
    ...
    def actualizar(
        ...
        *,
        ...
        # Actualizar el detalle de entrega
        try:
...
# Ejemplo de prueba para el CRUD de DetalleEntrega
